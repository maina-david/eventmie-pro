            ...
            <div class="page-content settings container-fluid">
                ...
                <div class="tab-content">
                    ...
                    <div id="{{ \Illuminate\Support\Str::slug($group) }}"
                        ...
                        <br>
                        <div class="alert alert-info">
                            {{ __('voyager::generic.Set Callback URL on your Google App Dashboard') }} -
                            <code>{{ route('eventmie.oauth_callback', ['social' => 'google']) }}</code>
                        </div>
                        @endif
                        ...
                        <br>
                        <div class="alert alert-info">
                            {{ __('voyager::generic.Set Callback URL on your Facebook App Dashboard') }} -
                            <code>{{ route('eventmie.oauth_callback', ['social' => 'facebook']) }}</code>
                        </div>
                        @endif
                        ...
                        <br>
                        <div class="alert alert-info">
                            {{ __('voyager::generic.Set Callback URL on your PayPal Dashboard') }} -
                            <code>{{ route('eventmie.bookings_paypal_callback') }}</code>
                        </div>
                        @endif

                        {{-- Info for TinyPesa Callback --}}
                        @if($setting->key == 'apps.tinypesa_apikey')
                        <br>
                        <div class="alert alert-info">
                        ...
                        <div class="panel-body no-padding-left-right">
                            <div class="col-md-10 no-padding-left-right">
                                ...
                                <input type="password" class="form-control" name="{{ $setting->key }}"
                                    value="{{ $setting->value }}">
                                ...
                                <select class="form-control" name="{{ $setting->key }}">
                                    ...
                                    <option value="{{ $index }}" @if($default==$index && $selected_value===NULL)
                                        selected="selected" @endif @if($selected_value==$index) selected="selected"
                                        @endif>{{ $option }}</option>
                                    @endforeach
                                    @endif
                                </select>
                                ...
                                <ul class="radio">
                                    ...
                                    <li>
                                        <input type="radio" id="option-{{ $index }}" name="{{ $setting->key }}"
                                            value="{{ $index }}" @if($default==$index && $selected_value===NULL) checked
