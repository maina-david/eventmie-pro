...
<section>
    <div class="lgx-banner event-poster background-tint"
        style="background-image: url({{ '/storage/'.$event['poster'] }});">
                        ...
                        <div class="lgx-banner-info-area">
                            <div class="lgx-banner-info-circle lgx-info-circle">
                                <div class="info-circle-inner"
                                    style="background-image: url({{ eventmie_asset('img/bg-wave-circle.png') }});">
                                    <h3 class="date">
                                        {{ userTimezone($event->start_date.' '.$event->start_time, 'Y-m-d H:i:s', 'd')
                                        }}

                                        <span>
                                            {{ userTimezone($event->start_date.' '.$event->start_time, 'Y-m-d H:i:s',
                                            'M-Y') .'('. showTimezone() .')' }}
                                        </span>
                                    </h3>
                            ...
                            <div class="lgx-heading">
                                ...
                                <h3 class="subheading">
                                    ...
                                    <a class="text-primary"
                                        href="{{route('organiser_show',[$organiser_slug]) }}">@lang('eventmie-pro::em.by')
                                        {{ $extra['organiser']->organisation }}</a>
                                    @endif
                                    {{-- CUSTOM --}}
                                    @if(!empty($event['online_location']))
                                    <span class="lgx-badge lgx-badge-online"><i class="fas fa-signal"></i>&nbsp;
                                    ...
                                    <span
                                        class="lgx-badge lgx-badge-primary">@lang('eventmie-pro::em.free_tickets')</span>
                                    @endif
                                    ...
                                    @if($ended)
                                    <span
                                        class="lgx-badge lgx-badge-danger">@lang('eventmie-pro::em.event_ended')</span>
                                    @endif
                                </h3>
                                ...
                                <h3 class="subheading share-btns">
                                    ...
                                    <span><a class="btn btn-sm" target="_blank"
                                            href="https://www.facebook.com/sharer/sharer.php?u={{ url()->current() }}"><i
                                                class="fab fa-facebook-square"></i></a></span>
                                    <span><a class="btn btn-sm" target="_blank"
                                            href="https://twitter.com/intent/tweet?text={{ urlencode($event->title) }}&url={{ url()->current() }}"><i
                                                class="fab fa-twitter"></i></a></span>
                                    <span><a class="btn btn-sm" target="_blank"
                                            href="http://www.linkedin.com/shareArticle?mini=true&url={{ url()->current() }}&title={{ urlencode($event->title) }}"><i
                                                class="fab fa-linkedin"></i></a></span>
                                    <span><a class="btn btn-sm" target="_blank"
                                            href="https://wa.me/?text={{ url()->current() }}"><i
                                                class="fab fa-whatsapp"></i></a></span>
                                    <span><a class="btn btn-sm" target="_blank"
                                            href="https://www.reddit.com/submit?title={{ urlencode($event->title) }}&url={{ url()->current() }}"><i
                                                class="fab fa-reddit"></i></a></span>
                                    <span><a class="btn btn-sm" href="javascript:void(0)" onclick="copyToClipboard()"><i
                                                class="fas fa-link"></i></a></span>
                                </h3>

                                <a class="lgx-btn lgx-btn-red mt-2" href="#buy-tickets"><i
                                        class="fas fa-ticket-alt"></i> @lang('eventmie-pro::em.get_tickets')</a>
                ...
                <div class="row">
                    <div class="col-12 col-sm-5 col-md-5 offset-md-1">
                        <div class="lgx-about-service">
                            <div class="lgx-single-service lgx-single-service-color">
                                <div class="text-area">
                                    <span class="icon col-white"><i class="fas fa-map-marked-alt"
                    ...
                    <div class="col-12 col-sm-5 col-md-5">
                        <div class="lgx-about-service">
                            <div class="lgx-single-service lgx-single-service-color">
                                <div class="text-area">
                                    <span class="icon col-white"><i class="fas fa-stopwatch"
                                            aria-hidden="true"></i></span>
                                    ...
                                    <p>
                                        {{ userTimezone($event->start_date.' '.$event->start_time, 'Y-m-d H:i:s',
                                        format_carbon_date(false)) }}
                                        {{ '('. showTimezone() .')' }}
                                        <br>@lang('eventmie-pro::em.till')<br>

                                        {{ userTimezone($event->end_date.' '.$event->end_time, 'Y-m-d H:i:s',
                                        format_carbon_date(false)) }}
                                    ...
                                    <p>
                                        ...
                                        <br>@lang('eventmie-pro::em.till')<br>
                                        {{ userTimezone($event->start_date.' '.$event->start_time, 'Y-m-d H:i:s',
                                        'Y-m-d') <= userTimezone($event->end_date.' '.$event->end_time, 'Y-m-d H:i:s',
                                            'Y-m-d') ? userTimezone($event->end_date.' '.$event->end_time, 'Y-m-d
                                            H:i:s', format_carbon_date(true)) : userTimezone($event->start_date.'
                                            '.$event->start_time, 'Y-m-d H:i:s', format_carbon_date(true))}}
                                    </p>
                                    @endif
            ...
            <div class="container">
                ...
                <div class="row">
                    <select-dates :event="{{ json_encode($event, JSON_HEX_APOS) }}"
                        ...
                        :currency="{{ json_encode($currency, JSON_HEX_APOS) }}" :total_capacity="{{ $total_capacity }}"
...
<section>
    <div id="lgx-schedule-tag" class="{{ ($i%2) ? 'lgx-schedule lgx-schedule-dark' : '' }}">
        <div class="lgx-inner"
            style="{{ ($i%2) ? 'background-image: url('.eventmie_asset('img/bg-pattern.png').');' : '' }}">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                                ...
                                <figure>
                                    <figcaption>
                                        ...
                                        <div class="social-group">
                                            <a class="sp-tw" href="{{ $value['twitter'] }}" target="_blank"><i
                                                    class="fab fa-twitter"></i></a>
                                            <a class="sp-fb" href="{{ $value['facebook'] }}" target="_blank"><i
                                                    class="fab fa-facebook"></i></a>
                                            <a class="sp-insta" href="{{ $value['instagram'] }}" target="_blank"><i
                                                    class="fab fa-instagram"></i></a>
                                            <a class="sp-in" href="{{ $value['linkedin'] }}" target="_blank"><i
                                                    class="fab fa-linkedin"></i></a>
                                            <a class="sp-in" href="{{ $value['website'] }}" target="_blank"><i
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-10">
                        <iframe src="https://www.youtube.com/embed/{{ $item }}" allowfullscreen
                            style="width: 100%; height: 500px; border-radius: 16px; border: none;"></iframe>
                    </div>
                    @else
                    <div class="col-md-6 mb-5">
                        <iframe src="https://www.youtube.com/embed/{{ $item }}" allowfullscreen
                            style="width: 100%; height: 300px; border-radius: 16px; border: none;"></iframe>
                    </div>
                    @endif
                    @endforeach
                    {{-- CUSTOM --}}
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <a href="{{'https://www.google.com/maps/search/'.$event->address.'/'.$event->latitude.','.$event->longitude}}"
                    class="lgx-btn lgx-btn-primary mt-5" id="get_directions"><i class="fas fa-location-arrow"></i>
                    @lang('eventmie-pro::em.get_directions')</a>
            </div>
        </div>
    </div>
</section>
...
<script type="text/javascript">
    ...
    var is_tinypesa = {!! json_encode( $extra['is_tinypesa']) !!};
