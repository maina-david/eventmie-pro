                    ...
                    >
                        ...
                        <div class="form-group pl-3" v-if="is_admin > 0">
                            ...
                            <label class="custom-control-label">{{
                                trans("em.complimentary_bookings")
                            }}</label>
                        </div>
                        <!-- CUSTOM -->
                        ...
                        <div
                            class="row"
                            v-if="
                                is_customer <= 0 && is_bulk <= 0 && is_pos <= 0
                            "
                        >
                            <!-- CUSTOM -->
                            <div class="col-md-5 mb-5 ml-4">
                                <label for="customer_id"
                                    >{{ trans("em.add") }}
                                    {{ trans("em.new") }}
                                    {{ trans("em.attendee") }}</label
                                ><br />
                                <button
                                    class="btn lgx-btn lgx-btn-black lgx-btn-sm"
                                    type="button"
                                    @click="add_attendee = 1"
                                >
                        ...
                        <div class="row" v-if="is_twilio > 0">
                            <div class="col-md-12 mb-5">
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        v-show="errors.has('phone_t')"
                                        class="help text-danger"
                                        >{{ errors.first("phone_t") }}</span
                                    >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="list-group m-0">
                                    ...
                                    <!-- CUSTOM -->
                                    <li
                                        class="list-group-item justify-content-between lh-condensed d-flex-wrap"
                                        v-for="(item, index) in tickets"
                                        :key="index"
                                    >
                                        <div
                                            class="row justify-content-around"
                                            v-if="item.sale_start_date != null"
                                        >
                                            <div
                                                class="col-xs-3"
                                                v-if="
                                        ...
                                        <ul
                                            class="list-group m-0 list-group-flush"
                                        >
                                            <li
                                                class="list-group-item d-flex justify-content-between lh-condensed d-flex-wrap"
                                            >
                                                ...
                                                <div
                                                    v-if="item.t_soldout > 0"
                                                    class="w-10 w-20-mobile"
                                                >
                                                    <p class="text-danger">
                                                        <small
                                                            ><i
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <button
                                                                class="btn lgx-btn lgx-btn-sm lgx-btn-success"
                                                                type="button"
                                                                @click="
                                                                    pc_readonly[
                                                                        index
                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="list-group m-0">
                                    ...
                                    <li
                                        ...
                                        v-if="total > 0 && promocode_reward > 0"
                                    >
                                        <span class="badge bg-green"
                                            ><strong
                                                >{{
                                                    "-" +
                                                    promocode_reward.toFixed(2)
                                                }}
                                                {{ currency }}</strong
                                            ></span
                                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <label
                                            class="custom-control-label"
                                            for="payment_method_authorize"
                                        >
                                            {{
                                                trans("em.authorizenet")
                                            }}</label
                                        >
                                    </div>
                                    ...
                                    >
                                        ...
                                        <label
                                            class="custom-control-label"
                                            for="payment_method_bitpay"
                                        >
                                            {{ trans("em.bitpay") }}</label
                                        >
                                    </div>
                                    ...
                                    >
                                        <input
                                            type="radio"
                                            class="custom-control-input"
                                            id="payment_method_stripe_direct"
                                            name="payment_method"
                                            v-model="payment_method"
                                            value="5"
                                        />
                                        <label
                                            class="custom-control-label"
                                            for="payment_method_stripe_direct"
                                        >
                                            &nbsp;<i class="fab fa-stripe"></i>
                                            {{
                                                trans("em.card_payment")
                            ...
                            <div class="col-xs-12" v-if="!register_user_id">
                                ...
                                <div class="btn-group btn-group-justified">
                                    ...
                                    <button
                                        ...
                                        @click="register_modal = 1"
                                    >
                                        <i class="fas fa-fingerprint"></i>
                                        {{ trans("em.continue_guest") }}
                                    </button>
                                </div>
                                <register-user
                                    v-if="register_modal > 0"
    ...
    methods: {
                ...
                this.quantity.forEach(
                    function (value, key) {
                        ...
                        if (this.tickets[key].is_donation <= 0) {
                            ...
                            value > 0 &&
                            this.tickets[key].is_donation > 0
                        ) {
                            amount = parseFloat(
                                1 * this.tickets[key].price
                            ).toFixed(2);
                        } else if (
                            value <= 0 &&
                            this.tickets[key].is_donation > 0
        ...
        defaultPaymentMethod() {
            ...
            if (
                ...
                this.orderTotal() > 0 &&
                (
                    parseFloat(this.total) - parseFloat(this.promocode_reward)
                ).toFixed(2) > 0
            )
            ...
            else this.payment_method = default_payment_method;
        ...
        applyPromocode(ticket_id = null, index = null) {
            ...
            if (
                (this.is_admin > 0 || this.is_organiser > 0) &&
                this.customer == null
            ) {
            ...
            if (
                ticket_id != null &&
                this.promocode[index] != null &&
                this.promocode[index] != "" &&
                this.promocode[index] != "undefined"
            ) {
                axios
                    .post(route("apply_promocodes"), {
                        ticket_id: ticket_id,
                        promocode: this.promocode[index],
                        customer_id:
                            this.is_customer > 0
                                ? this.register_user_id
                                : this.customer_id,
                    })
                    .then((res) => {
                        if (res.data.status > 0) {
                            ...
                            document.getElementById("pcb_" + index).innerHTML =
                                trans("em.applied");
                            ...
                            document.getElementById(
                                ...
                                res.data.promocode.reward +
                                (res.data.promocode.p_type == "fixed"
                                    ? this.currency
                                    : "%") +
                                " OFF!";
        ...
        promocodeReward() {
            ...
            if (Object.keys(this.ticket_promocodes).length > 0) {
                this.ticket_promocodes.forEach(
                    function (value, key) {
                        if (
                            value != "undefined" &&
                            value != "" &&
                            ...
                            if (value.p_type == "fixed") {
                                this.promocode_reward = isNaN(
                                    parseFloat(this.promocode_reward) +
                                        parseFloat(value.reward)
                                )
                                    ? this.promocode_reward
                                    : parseFloat(this.promocode_reward) +
                                      parseFloat(value.reward);
                            } else {
            ...
            this.quantity.forEach(
                function (value, key) {
                    ...
                    // promocode input field readonly
                        ...
                        // promocode apply button text change
                        document.getElementById("pcb_" + key).innerHTML =
                            trans("em.apply");
        ...
        timerOnSale(sale_start_date = null, sale_end_date = null) {
            if (sale_start_date == null || sale_end_date == null) return true;

            var local_tz = Intl.DateTimeFormat().resolvedOptions().timeZone;

            var a = this.userTimezone(
                sale_end_date,
                "YYYY-MM-DD HH:mm:ss"
            ...
            if (
                ...
                ms = moment(a, "DD/MM/YYYY HH:mm:ss")
                    .tz(local_tz)
                    .diff(moment(b, "DD/MM/YYYY HH:mm:ss").tz(local_tz)); //milliseconds
            }
                ...
                this.tickets.forEach(
                    function (value, key) {
                        if (value.is_donation > 0) {
                            if (
                                this.is_donation[key] == undefined ||
                                this.is_donation[key] == ""
                            ) {
                            ...
                            this.$parent.tickets[key].price = parseFloat(
                                this.is_donation[key]
                            ).toFixed(2);
